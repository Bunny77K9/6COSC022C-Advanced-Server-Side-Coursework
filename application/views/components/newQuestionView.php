<script type="text/template" id="add_question_template">
	...
	<!---->
	<!--	<div class="question-form-input">-->
	<!--		<p class="title">What are the details of your problem</p>-->
	<!--		<p class="description">Introduce the problem and expand on what you put in the title. Minimum 20 characters</p>-->
	<!---->
	<!--		<textarea class="form-control" id="inputQuestionDetails" name="inputQuestionDetails"-->
	<!--				  rows="3" required></textarea>-->
	<!--	</div>-->
	<!---->
	<!--	<div class="question-form-input">-->
	<!--		<p class="title">What did you try and what were you expecting?</p>-->
	<!--		<p class="description">describe what you tried, what you expected to happen, and what actually-->
	<!--				resulted. Minimum 20 Characters</p>-->
	<!--		<textarea class="form-control" id="inputQuestionExpectation" name="inputQuestionExpectation"-->
	<!--				  rows="3" required></textarea>-->
	<!--	</div>-->
	<!---->
	<!--	<div class="question-form-input">-->
	...
	<!--	<div class="question-form-input">-->
	<!--		<p class="title">Tags</p>-->
	<!--		<p class="description">Add up to 5 tags to describe what your question is about. Start typing to see suggestion </p>-->
	<!--		<input type="text" class="form-control" placeholder="e.g. (javascript, react, nodejs)"-->
	<!--			   required id="inputQuestionTags" name="inputQuestionTags">-->
	<!--	</div>-->
	<!---->
	<!--	<div class="question-form-input">-->
